...
![第一次访问]( https://hp.github.io/assets/images/posts/issues/cache-firstload.png){:height="100%" width="100%"}


接着直接刷新页面，如下图所示，在chrome DevTools中可以看到，2个requests，并且meii.jpg是从memory cache中拿到的。


![刷新页面]( https://hp.github.io/assets/images/posts/issues/cache-refreshload.png){:height="100%" width="100%"}
