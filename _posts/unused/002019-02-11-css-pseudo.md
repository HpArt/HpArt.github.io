...
![css pseudo-classes]( https://hp.github.io/assets/images/posts/css/css-pseudo-classes.png){:height="100%" width="100%"}

![css pseudo-elements]( https://hp.github.io/assets/images/posts/css/css-pseudo-elements.png){:height="100%" width="100%"}
...
![css pseudo-classes-img]( https://hp.github.io/assets/images/posts/css/css-pseudo-classes-img.png){:height="100%" width="100%"}
...
![css css-pseudo-elements-img]( https://hp.github.io/assets/images/posts/css/css-pseudo-elements-img.png){:height="100%" width="100%"}
